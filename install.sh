...
DAEMON="/home/vagrant/streamon/blockmon"
# File xml
...
case $1 in
 start)
  ...
  if start-stop-daemon --start --background --make-pidfile --pidfile $PIDFILE -d /home/vagrant/streamon --exec ${DAEMON} ${DAEMON_OPTS} ; then
   log_end_msg 0
  else
   log_end_msg 1
  fi
